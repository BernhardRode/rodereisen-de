...
const parseOffer = ({ basketId, body, footer, header, image, link, logo, offerId, review, }) => {
    try {
...
const cache = {};
const getOffers = (id = "PRBG-2151") => __awaiter(void 0, void 0, void 0, function* () {
    if (cache[id]) {
        return cache[id];
    }
    const url = `${BASE_URL}/${id}`;
    const offersPage = yield node_fetch_1.default(url);
    const offersBody = yield offersPage.text();
    const root = node_html_parser_1.parse(offersBody, {});
